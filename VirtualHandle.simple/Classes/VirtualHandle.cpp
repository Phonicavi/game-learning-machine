...
bool VirtualHandle::init()
{
    ...
    this->_rocker_range_value = 1.2*_rocker->getContentSize().width;
...
//    CCLOG("%f", this->_rocker_range_value/2);
    ...
    _a->setPosition(Vec2(visibleSize.width-1.5*_a->getContentSize().width-_margin.x+5,
                         _rocker_range_value/2-18));
    _b->setPosition(Vec2(visibleSize.width-_b->getContentSize().width/2-_margin.x+2,
